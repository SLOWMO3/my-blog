...
-- 기존 카테고리 전체 삭제 후 음식 카테고리 4개만 삽입
DELETE FROM categories;

INSERT INTO categories (name, slug, description, color) VALUES
('한식', 'korean', '한식의 다양한 음식과 레시피, 전통과 현대의 맛을 소개합니다.', '#ef4444'),
('중식', 'chinese', '중국 각지의 요리와 음식 문화, 인기 중식 레시피를 만나보세요.', '#f59e42'),
('양식', 'western', '유럽, 미국 등 서양의 다양한 음식과 레스토랑, 미식 트렌드를 소개합니다.', '#3b82f6'),
('일식', 'japanese', '일본의 전통과 현대 요리, 인기 일식 레시피와 음식 문화를 탐험하세요.', '#10b981')
